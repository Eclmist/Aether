Shader "HDRP/Open World Nature/Vegetation"
{
    Properties
    {
        _AlphaClip("Alpha Clip", Range(0, 1)) = 0.33
        ...
        // We need isFontFace when using double sided
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Shared Graph Node Functions
                    ...
                    void SG_GetHeightMask_60ae5a3adf0ed5040ad3d47f11f13d66(float Boolean_878E1403, float Boolean_2F5102EA, float Boolean_AF1DE570, Bindings_GetHeightMask_60ae5a3adf0ed5040ad3d47f11f13d66 IN, out float Mask_1)
                    {
                        ...
                        Mask_1 = _OneMinus_B7187D07_Out_1;
                    }
                    ...
                    void SG_ApplyWindDisplacement_4cffdb48e822c9f4bb7d8163fb91d4f6(float3 Vector3_C96069F9, float Vector1_A5EB719C, float Vector1_4D1D3B1A, float3 Vector3_C80E97FF, float3 Vector3_821C320A, float3 Vector3_4BF0DC64, float Boolean_2DC08AA7, Bindings_ApplyWindDisplacement_4cffdb48e822c9f4bb7d8163fb91d4f6 IN, out float3 WorldPosition_0)
                    {
                ...
                // Vertex Graph Evaluation
                    VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
                    {
                        ...
                        float _Split_ACBF6249_R_1 = IN.AbsoluteWorldSpacePosition[0];
                        float _Split_ACBF6249_G_2 = IN.AbsoluteWorldSpacePosition[1];
                        float _Split_ACBF6249_B_3 = IN.AbsoluteWorldSpacePosition[2];
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        float _Property_4BBBB61C_Out_0 = _AlphaClip;
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Pixel Graph Evaluation
                    SurfaceDescription SurfaceDescriptionFunction(SurfaceDescriptionInputs IN)
                    {
                        ...
                        surface.Smoothness = _SampleTexture2D_FFEA8409_A_7;
                        surface.Alpha = _SampleTexture2D_F86B9939_A_7;
                        surface.Alpha = min(ATH_Compute_Visibility(IN.AbsoluteWorldSpacePosition), surface.Alpha);
