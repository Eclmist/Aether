Shader "HDRP/Open World Nature/Tree Bark"
{
    Properties
    {
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Vertex Graph Evaluation
                    VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
                    {
                        ...
                        Unity_Subtract_float3(IN.AbsoluteWorldSpacePosition, _GetPivotInWorldSpace_73F19E42_PivotInWS_0, _Subtract_8C2882_Out_2);
