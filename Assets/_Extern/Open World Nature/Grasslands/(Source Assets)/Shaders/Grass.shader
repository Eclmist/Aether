Shader "HDRP/Open World Nature/Grass"
{
    Properties
    {
    ...
    SubShader
    {
            ...
            //-------------------------------------------------------------------------------------
                ...
                // Vertex Graph Evaluation
                    VertexDescription VertexDescriptionFunction(VertexDescriptionInputs IN)
                    {
                        ...
                        float _Split_EDB5F22E_R_1 = IN.AbsoluteWorldSpacePosition[0];
                        float _Split_EDB5F22E_G_2 = IN.AbsoluteWorldSpacePosition[1];
                        float _Split_EDB5F22E_B_3 = IN.AbsoluteWorldSpacePosition[2];
        ...
        // We need isFontFace when using double sided
            ...
            //-------------------------------------------------------------------------------------
                    ...
                    SAMPLER(_SampleTexture2D_F369DF5C_Sampler_3_Linear_Repeat);
